...
import { AlertTriangle, Clock, MapPin, User, AlertCircle, CheckCircle2, Users } from 'lucide-react';
...
interface Conflict {
  id: string;
  type: 'lecturer' | 'venue' | 'class-group';
  severity: 'high' | 'medium' | 'low';
  description: string;
  affectedClasses: ScheduledClass[];
}
...
export function ConflictDetectionPanel({ scheduledClasses }: ConflictDetectionPanelProps) {
  // Detect conflicts
