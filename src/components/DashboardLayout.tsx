  ...
  return (
    <div className="min-h-screen bg-slate-50">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-white rounded-lg p-2">
                  <img src="/bucc-logo-raw.png" alt="School of Computing Logo" className="size-6 object-contain" />
                </div>
                <div>
                  <h1 className="text-lg font-bold text-white">School of Computing</h1>
              ...
              <div className="hidden md:flex items-center gap-3">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-slate-300">
                    <span>{roleTitle}</span>
                    {userDepartment ? <span> • {userDepartment}</span> : null}
                  </div>
                </div>
              </div>
              <Button
      ...
      <div className="flex">
        ...
        {/* Main Content */}
        <main className="flex-1 min-h-[calc(100vh-57px)] p-6 lg:p-8 flex flex-col">
          {children}
        </main>
      </div>
