-- Run this in Supabase Dashboard → SQL Editor if you get 404 on get_or_create_time_slot.
-- This creates the RPC so DTTO (and STTO) can create schedules without direct INSERT on time_slots.
